...
author: "Observatório do Mercado de Trabalho do Maranhão (OMT-MA"
date: "29/10/2019"
output:
  html_document:
    html_document:
...
setwd("~/Downloads/pof-2017-2018-master") # indica o diretorio de trabalho 
#setwd("C:\\Users\\omtmaranhao\\Documents\\POF\\")
rm(list = ls())

######################################## 2017-2018 REGISTRO - RENDIMENTO DO TRABALHO ######################################
rendimento_total_var_patrim_2017_2018 <- read_xlsx("21MA.xls.xlsx",
                                                   skip = 11,
                                                   sheet = 5,
